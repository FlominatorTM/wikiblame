...
$messages['March'] = 'Mart';
$messages['April'] = 'Nisan';
$messages['May'] = 'Mayıs';
$messages['June'] = 'Haziran';
$messages['July'] = 'Temmuz';
$messages['August'] = 'Ağustos';
$messages['September'] = 'Eylül';
$messages['October'] = 'Ekim';
$messages['November'] = 'Kasım';
$messages['December'] = 'Aralık';
...
$messages['binary_search_inverse'] = 'Metnin kaldırılması için ara (yalnızca ikili)';
$messages['search_method'] = 'Arama tipi';
$messages['binary'] = 'ikili';
$messages['binary_in_wp'] = 'https://tr.wikipedia.org/wiki/İkili_arama_algoritması';
...
$messages['from_url'] = 'URL ile';
$messages['paste_url'] = 'Lütfen URL\'yi MediaWiki sayfasına yapıştırın';
...
$messages['inverse_stuck'] = 'Bu _NUMBEROFVERSIONS_ revizyonunda ekleme veya kaldırma bulunamadı. Arama terimi daha önce kaldırılmış mıydı?';
...
$messages['execution_time'] = 'Çalıştığı süre: _EXECUTIONTIME_ saniye';
...
$messages['dead_end'] = 'Çıkmaz yakalandı (muhtemelen geri alımlar ya da değişiklik savaşları nedeniyle)';
$messages['once_more'] = 'Bir kez daha, duygu ile:';
$messages['delete_from_here'] = '_NUMBEROFVERSIONS_ önceki revizyonu silme, kaldırma işlemi daha sonra gerçekleştirilmiş olmalı';
$messages['delete_until_here'] = '_NUMBEROFVERSIONS_ sonraki revizyonu silme, ekleme daha önce gerçekleştirilmiş olması gerektiğinden';
...
$messages['not_found_at_all'] = 'Aradığınız terim bulunamadı. Ayarları kontrol edin ve tekrar deneyin.';
