...
$messages['October'] = 'اکتبر';
$messages['November'] = 'نوامبر';
$messages['December'] = 'دسامبر';
$messages['ui_lang'] = 'نمایش زوون';
$messages['lang'] = 'زوون';
$messages['project'] = 'پروژۀ';
$messages['article'] = ':وةڵگە(پەڕە)';
$messages['needle'] = 'مِه نِی کردن ئةرا-جستجوبرای';
...
$messages['start_date'] = 'تاریخ شؤروع';
...
$messages['start'] = 'باج گِلّ-شروع کن';
$messages['reset'] = 'إژ دووارة';
$messages['manual'] = 'راهنما/رئ نیشاندر';
$messages['contact'] = 'مخاطب';
...
$messages['please_wait'] = '… لطفاً صبر کنید/گِڕێ بووسِن';
...
$messages['help_translating'] = 'در ترجمه در translatewiki.net کمک کنید';
$messages['start_here'] = 'جستجو از اینجا';
...
$messages['not_found_at_all'] = 'جستجوی شما به هیچ وجه یافت نشد.تنظیمات را بازبینی کنید و از نو تلاش نمائید.';
