...
$messages['get_less_versions'] = 'Votre recherche peut requérir __NUMREVISIONS__ versions à la fois. Afin de protéger le serveur, vous n’êtes autorisé{{GENDER:||e}} à requérir que __ALLOWEDREVISIONS__ par appel. Veuillez modifier les paramètres ou basculer vers la méthode de recherche dichotomique !';
...
$messages['inverse_stuck'] = 'Aucune insertion ni suppression trouvée parmi ces _NUMBEROFVERSIONS_ versions. Se pourrait-il que le terme recherché ait été supprimé antérieurement ?';
