...
$messages['binary'] = '折半';
$messages['linear'] = '線性';
$messages['interpolated'] = '折半（在更多的版本中較快）';
...
$messages['manual'] = '手冊';
$messages['contact'] = '聯絡';
$messages['get_less_versions'] = '您的搜尋可能會在一次內回報 __NUMREVISIONS__ 個版本，為了保護服務器，您每次能取得的搜尋回報為 __ALLOWEDREVISIONS__ 個以內，請變更設定或把搜尋模式轉為折半模式！';
