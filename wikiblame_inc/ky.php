...
$messages['January'] = 'Январь (Үчтүн айы)';
$messages['February'] = 'Февраль (Бирдин айы)';
$messages['March'] = 'Март (Жалган куран)';
$messages['April'] = 'Апрель (Чын куран)';
$messages['May'] = 'Май (Бугу)';
$messages['June'] = 'Июнь (Кулжа)';
$messages['July'] = 'Июль (Теке)';
$messages['August'] = 'Август (Баш оона)';
$messages['September'] = 'Сентябрь (Аяк оона)';
$messages['October'] = 'Октябрь (Тогуздун айы)';
$messages['November'] = 'Ноябрь (Жетинин айы)';
$messages['December'] = 'Декабрь (Бештин айы)';
