...
$messages['delete_from_here'] = 'Deleting _NUMBEROFVERSIONS_ earlier revisions, καθώς η αφαίρεση έπρεπε να είχε γίνει νωρίτερα';
$messages['delete_until_here'] = 'Deleting _NUMBEROFVERSIONS_ later revisions, desde que la insercion deberian ser performado mas temprano';
