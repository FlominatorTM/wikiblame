...
$messages['binary'] = 'δυαδικό αρχείο';
...
$messages['from_url'] = 'από URL';
$messages['paste_url'] = 'Παρακαλώ επικολλήστε το URL για την σελίδα MediaWiki';
$messages['no_valid_url'] = 'Δεν είναι έγκυρο URL MediaWiki';
$messages['start'] = 'Έναρξη';
$messages['reset'] = 'Επαναφορά';
$messages['manual'] = 'Εγχειρίδιο';
$messages['contact'] = 'Επικοινωνία';
$messages['source_code'] = 'Πηγαίος κώδικας στο GitHub';
$messages['get_less_versions'] = 'Η αναζήτησή σας μπορεί να κάνει ερωτήματα για __NUMREVISIONS__ εκδόσεις κάθε φορά. Προκειμένου να προστατευθεί ο διακομιστής, σας επιτρέπεται να κάνετε ερώτημα για __ALLOWEDREVISIONS__ ανά κλήση. Παρακαλούμε αλλάξτε τις ρυθμίσεις ή αλλάξτε την μέθοδο αναζήτησης σε δυαδική!';
$messages['wrong_skips'] = 'Λάθος ρυθμίσεις: εάν παρακάμπτονται οι πρώτες __VERSIONSTOSKIP__ εκδόσεις, τότε καμία από τις __VERSIONSTOSEARCH__εκδόσεις που πρέπει να αναζητηθεί θα υποβληθούν σε επεξεργασία.';
...
$messages['inverse_stuck'] = 'Δεν βρέθηκε εισαγωγή ή διαγραφή σε αυτές τις _NUMBEROFVERSIONS_ αναθεωρήσεις. Μήπως διαγράφηκε ο όρος αναζήτησης νωρίτερα;';
$messages['inverse_earliest'] = 'Αναζητήστε σε προηγούμενες αναθεωρήσεις';
...
$messages['binary_test'] = 'Σύγκριση των διαφορών στην _FIRSTDATEVERSION_ μεταξύ _FIRSTNUMBER_ και _SECONDNUMBER_ ενώ ερχόμαστε από _SOURCENUMBER_:';
$messages['dead_end'] = 'Ανιχνεύθηκε κάποιο αδιέξοδο (πιθανώς προκλήθηκε από επαναφορές ή διορθωπόλεμους)';
$messages['once_more'] = 'Για άλλη μια φορά, με συναίσθημα:';
$messages['delete_from_here'] = 'Διαγραφή _NUMBEROFVERSIONS_ προηγούμενων αναθεωρήσεων, καθώς η αφαίρεση έπρεπε να είχε γίνει νωρίτερα';
$messages['delete_until_here'] = 'Διαγραφή _NUMBEROFVERSIONS_ μετέπειτα αναθεωρήσεων, καθώς οι εισαγωγές έπρεπε να είχαν γίνει νωρίτερα';
