...
$messages['wrong_skips'] = 'Wopačne nastajenja: Jeli so prěnje wersije __VERSIONSTOSKIP__ přeskakuja, žadyn z wersijow __VERSIONSTOSEARCH__, kotrež maja so pytać, so njepředźěła.';
