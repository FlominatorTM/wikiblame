...
$messages['ui_lang'] = 'Monstrar lingue';
$messages['lang'] = 'Lingue';
$messages['project'] = 'Projecte';
$messages['article'] = 'Págine';
$messages['needle'] = 'Serchar por';
$messages['skipversions'] = 'Sempre saltettar x versiones';
...
$messages['get_less_versions'] = 'Tui sercha vell contestar __NUMREVISIONS__ revisiones in un témpor. In órdine por protecter li servitor, vu es solmen admisset por contestar por __ALLOWEDREVISIONS__ per convocation. Pleser change li colocationes o comuta li metode de sercha por binare!';
$messages['wrong_skips'] = 'Colocationes íncorect: Si li prim __VERSIONSTOSKIP__ versiones es saltettat, tande nequant del __VERSIONSTOSEARCH__ versiones por esser serchat va esser processed.';
...
$messages['binary_test'] = 'Comparant diferenties in _FIRSTDATEVERSION_ inter _FIRSTNUMBER_ e _SECONDNUMBER_ durante que venint de _SOURCENUMBER_:';
$messages['dead_end'] = 'Atinget alcun fine mort (probabilmen causat per revertiones o guerre de redactiones)';
$messages['once_more'] = 'Un vez plu, che sensation:';
...
$messages['not_found_at_all'] = 'Tui condition de sercha ne esset consatatat in omni. Vu comprende se, vu have obtenet li colocationes corect?';
