...
$messages['revision_date_format'] = "%d. %B %Y, %H:%M Uhr"; //hour:minute, day monthname year
...
$messages['delete_from_here'] = 'Lösche _NUMBEROFVERSIONS_ frühere Versionen, da Löschung später vorgenommen wurde';
