...
$messages['February'] = 'پیبروری';
$messages['March'] = 'مارچ';
$messages['April'] = 'آپریل';
$messages['May'] = 'مَی';
$messages['June'] = 'جون';
$messages['July'] = 'جولای';
$messages['August'] = 'آگوست';
$messages['September'] = 'سپٹامبر';
...
$messages['start_date'] = 'بنگݔجء رمس';
$messages['date_format'] = 'م‌م رر، س‌س‌س‌س';
$messages['order'] = 'نامݔنگ';
$messages['newest_first'] = 'گُڈی';
$messages['oldest_first'] = 'گُڈی ترݔن';
$messages['binary_search_inverse'] = 'پاک بیتگݔنء دُنب‌ئا بی (فقط دودویی)';
$messages['search_method'] = 'شۏھازء پئیم';
$messages['binary'] = 'دودویی';
$messages['linear'] = 'خطی';
$messages['interpolated'] = 'دودویی (گݔشتر گۏن زیتݔن ورژنان)';
$messages['ignore_minors'] = 'چشم‌پوشی از تغییرات جزئی (آزمایشی)';
$messages['force_wikitags'] = 'جستجوی اجباری ویکی متن';
$messages['start'] = 'بنگݔج';
$messages['reset'] = 'چھردیگ';
$messages['manual'] = 'دستی';
$messages['contact'] = 'رابتہ';
...
$messages['search_in_progress_text'] = 'ورژنء گوَستانک _ARTICLELINK_ پہ <b>_NEEDLE_</b> سادہ‌ئݔن نبشتانکء جاھا شۏھازن';
...
$messages['earlier_versions_available'] = 'بلکݔن وھدیگترݔن ورژنے ھن ھست اِنت۔';
...
$messages['deletion_found'] = 'حذف بین LEFT_VERSION و RIGHT_VERSION یافت بوت';
$messages['here'] = 'ادا';
$messages['help_translating'] = 'translatewiki.net ء رجانک کاری‌ئا کومک کن اݔت۔';
$messages['start_here'] = 'شۏھاز چہ ادا';
$messages['too_much_versions'] = 'شما به محدودیت کوئری __VERSIONLIMIT__ نسخه رسیده‌اید. لطفاً پس از __WAITMINUTES__ دقیقه دوباره بیازمایید یا به جستجوی دودویی بروید. از مزاحمت پیش‌آمده پوزش می‌طلبیم.';
$messages['not_found_at_all'] = 'شمئی شۏھاز در نہ کَپت.ردانکان بہ چار اݔت ءُ پدا کۏشست بہ کن اِت.';
