...
$messages['ignorefirst'] = 'Eerste x-aantal versies negeren';
$messages['limit'] = 'Aantal te controleren versies';
$messages['start_date'] = 'Begindatum';
$messages['date_format'] = 'DD-MM-YYYY';
$messages['revision_date_format'] = '%H:%M, %d %B %Y';
$messages['order'] = 'Volgorde';
$messages['newest_first'] = 'nieuwste bovenaan';
$messages['oldest_first'] = 'oudste bovenaan';
$messages['binary_search_inverse'] = 'Zoeken naar verwijderde tekst (alleen binair)';
$messages['search_method'] = 'Zoekmethode';
$messages['binary'] = 'binair';
$messages['linear'] = 'lineair';
$messages['interpolated'] = 'binair (sneller bij meerdere versies)';
$messages['ignore_minors'] = 'Kleine wijzigingen negeren (experimenteel)';
$messages['force_wikitags'] = 'Zoeken naar wikitekst forceren';
$messages['from_url'] = 'van url';
$messages['paste_url'] = 'Plak de url van een MediaWiki-pagina';
$messages['no_valid_url'] = 'Dit is geen geldige MediaWiki-url';
...
$messages['inverse_stuck'] = 'Er is niets toegevoegd of verwijderd in deze  _NUMBEROFVERSIONS_ versie(s).';
$messages['inverse_earliest'] = 'Eerdere versies doorzoeken';
...
$messages['latest_version_present'] = '__NEEDLE__ was al aanwezig in de eerste versie van __REVISIONLINK__.';
...
$messages['binary_test'] = 'Bezig met het vergelijken van de verschillen in _FIRSTDATEVERSION_ tussen _FIRSTNUMBER_ en _SECONDNUMBER_ met als uitgangspunt _SOURCENUMBER_:';
$messages['dead_end'] = 'Het programma is vastgelopen. Dit komt waarschijnlijk door teruggedraaide versies of bewerkingsoorlogen.';
$messages['once_more'] = 'Nog een keer, nu met gevoel:';
$messages['delete_from_here'] = '_NUMBEROFVERSIONS_ eerdere versies worden verwijderd, omdat verwijderen later moet zijn gebeurd';
$messages['delete_until_here'] = '_NUMBEROFVERSIONS_ latere versies worden verwijderd, omdat toevoegen eerder moet zijn gebeurd';
...
$messages['here'] = 'hier';
$messages['help_translating'] = 'Helpen met vertalen op translatewiki.net';
$messages['start_here'] = 'Zoeken vanaf hier';
$messages['too_much_versions'] = 'U heeft de zoeklimiet van __VERSIONLIMIT__ versies bereikt. Probeer het over __WAITMINUTES__ minuten opnieuw of maak gebruik van de binaire zoekmethode. Excuses voor het ongemak.';
$messages['not_found_at_all'] = 'Uw zoekopdracht leverde geen resultaten op. Controleer de instellingen en probeer het opnieuw.';
