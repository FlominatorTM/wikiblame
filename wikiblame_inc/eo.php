...
$messages['inverse_restart'] = 'Neniu enmeto aŭ forigo trovita; ĉu la serĉita(j) vorto(j) enmetiĝis pli malfrue?';
$messages['inverse_stuck'] = 'Neniu enmeto aŭ forigo en tiuj _NUMBEROFVERSIONS_ revizioj; ĉu la serĉita(j) vorto(j) foriĝis pli frue?';
...
$messages['dead_end'] = 'La programo ne povas finiĝi (probable pro malfaritaj redaktoj aŭ redaktomilitoj)';
$messages['once_more'] = 'Ankoraŭfoje, ĉi-foje kun sento:';
$messages['delete_from_here'] = 'Forigante _NUMBEROFVERSIONS_ pli fruajn reviziojn, ĉar forigo devas esti okazinta pli malfrue';
$messages['delete_until_here'] = 'Forigante _NUMBEROFVERSIONS_ pli malfruajn reviziojn, ĉar enmeto devas esti okazinta pli frue';
