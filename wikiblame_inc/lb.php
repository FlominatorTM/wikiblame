...
$messages['ui_lang'] = 'Sprooch vum Interface';
$messages['lang'] = 'Sprooch';
$messages['project'] = 'Projet';
$messages['tld'] = 'Domain';
$messages['tld_example'] = 'org, com, net, …';
$messages['article'] = 'Säit';
$messages['needle'] = 'Sichen no';
$messages['skipversions'] = 'Ëmmer x Versiounen iwwersprangen';
$messages['ignorefirst'] = 'Déi éischt x Versiounen ignoréieren';
$messages['limit'] = 'Versioune fir ze duerchsichen';
...
$messages['binary_search_inverse'] = 'Nom Läsche vum Text sichen (nëmmen am binäre Modus)';
...
$messages['ignore_minors'] = 'Kleng Ännerungen ignoréieren (experimentell)';
...
$messages['inverse_stuck'] = 'Näischt an dëse(n) _NUMBEROFVERSIONS_ Versioune fonnt, wat dragesat oder erausgeholl gouf. Gouf de Sichbegrëff eventuell méi fréi ewechgeholl?';
$messages['inverse_earliest'] = 'A virege Versioune sichen';
$messages['first_version'] = 'D\'Ännerung muss an der éischter oder leschter Versioun geschitt sinn?';
$messages['first_version_present'] = '__NEEDLE__ war schonn an der eelster duerchsichter Versioun vum __REVISIONLINK__ dran.';
$messages['latest_version_present'] = '__NEEDLE__ war schonn an der jéngster duerchsichter Versioun vum __REVISIONLINK__ dran.';
$messages['earlier_versions_available'] = 'Et gëtt warscheinlech méi al Versiounen.';
...
$messages['please_wait'] = 'Waart wgl. ...';
...
$messages['dead_end'] = 'An enger Sakgaass hänkebliwwen (warscheinlech wéinst Zerécksetze vun Artikelen oder Ännerungskonflikten)';
$messages['once_more'] = 'Nach emol, mat Gefill:';
$messages['delete_from_here'] = 'Läsche vu(n) _NUMBEROFVERSIONS_ virege Versioune, well d\'Ewechuele méi spéit gemaach gi si muss';
$messages['delete_until_here'] = 'Läsche vu(n) _NUMBEROFVERSIONS_ méi spéide Versioune, well d\'Ewechuele méi fréi gemaach gi si muss';
$messages['binary_enough'] = 'D\'Sich gouf en ettlechmol widderholl, den Historique vum Artikel ass net iwwersiichtlech, probéiert wgl. fir e puer Astellungen z\'änneren.';
...
$messages['too_much_versions'] = 'Dir hutt d\'Limit vu(n) __VERSIONLIMIT__ Versiounen vun der Zuel vun Ären Ufroen erreecht. Waart wgl. __WAITMINUTES__ Minutten oder wiessel op d\'binair Sich. Pardon fir dës Limitatioun.';
