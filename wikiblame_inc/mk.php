...
$messages['no_differences'] = 'Нема пронајдено разлики во пребараните ревизии.';
$messages['first_version'] = 'Веројатно промените се случиле првата или последната ревизија?';
$messages['first_version_present'] = '__NEEDLE__ беше уште во првата проајдена ревизија која датира од __REVISIONLINK__.';
$messages['earlier_versions_available'] = 'Веројатно постојат претходни верзии.';
...
$messages['not_found_at_all'] = 'Бараниот поим воопшто не е најден. Дали сте сигурни дека сте наместиле како што треба во нагодувањата?';
