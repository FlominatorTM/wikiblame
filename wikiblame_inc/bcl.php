...
$messages['September'] = 'Septiyembre';
$messages['October'] = 'Oktobre';
$messages['November'] = 'Nobyembre';
$messages['December'] = 'Disyembre';
$messages['ui_lang'] = 'Ipahiling an lengguwahe';
$messages['lang'] = 'Lengguwahe';
$messages['project'] = 'Proyekto';
$messages['article'] = 'Pahina';
$messages['needle'] = 'Maghanap kan';
$messages['skipversions'] = 'Pirmeng laktawan an x na mga bersyon';
$messages['ignorefirst'] = 'Dae pansinon an enot na mga x bersyon';
...
$messages['binary_search_inverse'] = 'Hanapon para sa pagtangkas kan teksto (binaryo sana)';
$messages['search_method'] = 'Paagi sa paghanap';
$messages['binary'] = 'binaryo';
$messages['linear'] = 'linaryo';
...
$messages['get_less_versions'] = 'An saimong paghanap naghahapot _NUMREVISIONS_ nin mga rebisyon nin sarong beses. Tanganing maprotektaran an serbidor, ikaw tinutugutan sana na maghapot para sa _ALLOWEDREVIIONS_ kada apod. Pakiliwat kan mga panuytoy or ribayi an paagi kan paghanap na magin binaryo!';
$messages['wrong_skips'] = 'Sala an mga panuytoy: Kun an enot _VERSIONSTOSKIP_ na mga bersyon pinagluktusan, mayo kan _VERSIONSTOSEARCH_ mga bersyon na paghahanapon na ipagpoproseso.';
...
$messages['please_wait'] = 'Pakihalat man tabi...';
...
$messages['not_found_at_all'] = 'An termino na saimong pinaghanap dae baya nanunumpungan. Pakihilnga tabi an mga panuytoy asin otroha giraray.';
