...
$messages['binary_search_inverse'] = '寻找已去除的文本（仅限折半搜索）';
$messages['search_method'] = '搜索方式';
$messages['binary'] = '折半';
$messages['linear'] = '线性';
$messages['interpolated'] = '折半（在更多的版本中更快）';
...
$messages['manual'] = '手册';
$messages['contact'] = '联系';
$messages['get_less_versions'] = '您的搜索可能一次查询 __NUMREVISIONS__ 个修订版本。为了保护服务器，您的每次调用只被允许查询 __ALLOWEDREVISIONS__ 个修订。请更改设置或切换查询模式到折半搜索！';
$messages['wrong_skips'] = '错误的设置：如果跳过首__VERSIONSTOSKIP__版本，那么要搜索的__VERSIONSTOSEARCH__个版本将不会被处理。';
...
$messages['first_version_present'] = '__NEEDLE__已被发现可以追潮到自首__REVISIONLINK__的首个版本中存在。';
...
$messages['binary_test'] = '在来自 _SOURCENUMBER_ 时，正在比较在 _FIRSTNUMBER_ 和 _SECONDNUMBER_ 之间，_FIRSTDATEVERSION_ 的差异：';
$messages['dead_end'] = '抓住了一些死胡同（可能造成的归还或编辑大战）';
$messages['once_more'] = '再一次，有感而发：';
$messages['binary_enough'] = '执行足够的重试次数，条历史很乱了，请试着更改某些设置。';
$messages['insertion_found'] = 'LEFT_VERSION 和 RIGHT_VERSION 之间发现了插入';
...
$messages['too_much_versions'] = '您已到达您的 __VERSIONLIMIT__ 个版本的查询限制。请在 __WAITMINUTES__ 分钟后再试，或切换到二进制搜索。不便之处，敬请原谅。';
