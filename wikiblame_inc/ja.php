...
$messages['get_less_versions'] = 'あなたの検索クエリーは__NUMREVISIONS__件の版を一度に検査する可能性があります。サーバーを保護するため、一度の呼び出しでは__ALLOWEDREVISIONS__件までに制限されています。設定を変更するか、検索方法をバイナリーにしてください！';
