...
$messages['June'] = 'Juni';
$messages['July'] = 'Juli';
$messages['August'] = 'Augusti';
$messages['September'] = 'September';
$messages['October'] = 'Oktober';
$messages['November'] = 'November';
$messages['December'] = 'December';
$messages['ui_lang'] = 'Visa språk';
$messages['lang'] = 'Språk';
$messages['project'] = 'Projekt';
$messages['tld'] = 'Domän';
$messages['tld_example'] = 'org, com, net, …';
$messages['article'] = 'Sida';
$messages['needle'] = 'Sök efter';
$messages['skipversions'] = 'Hoppa alltid över x versioner';
$messages['ignorefirst'] = 'Ignorera x första versioner';
$messages['limit'] = 'Versioner att kontrollera';
...
$messages['binary_in_wp'] = 'https://sv.wikipedia.org/wiki/Binärsökning';
...
$messages['source_code'] = 'Källkod på GitHub';
...
$messages['delete_from_here'] = 'Raderar _NUMBEROFVERSIONS_ tidigare versioner, eftersom borttagning måste ha utförts senare';
$messages['delete_until_here'] = 'Raderar _NUMBEROFVERSIONS_ senare versioner, eftersom en inläggning måste ha inträffat tidigare';
