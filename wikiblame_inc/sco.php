...
$messages['start_date'] = 'Stairt date';
...
$messages['interpolated'] = 'binarie (faster wi mair versions)';
$messages['ignore_minors'] = 'Ignore smaa chynges (expereemental)';
$messages['force_wikitags'] = 'Force rakin fer wikitex';
$messages['start'] = 'Stairt';
$messages['reset'] = 'Reset';
$messages['manual'] = 'Manual';
$messages['contact'] = 'Contact';
$messages['get_less_versions'] = 'Yer rake micht speir fur __NUMREVISIONS__ revisions at ae time. In order tae fend the server, yer anely alloued tae speir fur __ALLOWEDREVISIONS__ per caw. Please chynge the settins or switch the rake method tae binary!';
...
$messages['search_in_progress_text'] = 'The version history o _ARTICLELINK_ is bein raked fur <b>_NEEDLE_</b> as plain tex';
$messages['search_in_progress_wikitags'] = 'The version histerie o _ARTICLELINK_ is bein raked fer <b>_NEEDLE_</b> aes wiki tex';
$messages['no_differences'] = 'Nae differences fand in raked revisions.';
...
$messages['dead_end'] = 'Caucht some deid end (likely caused bi reverts or edit wars)';
$messages['once_more'] = 'Yince mair, wi feelin:';
$messages['binary_enough'] = 'Performt eneuch retries, airticle histerie is fair messed up, please try chyngin some settins.';
$messages['insertion_found'] = 'Insertion foond atween LEFT_VERSION n RIGHT_VERSION';
$messages['deletion_found'] = 'Deletion fand atween LEFT_VERSION an RIGHT_VERSION';
$messages['here'] = 'here';
