...
$invert_sense       = (param('invert_sense') == 'on')                       ? TRUE : FALSE;
...
<div align="center">
		...
		<input type="hidden" name="user_lang" value="<?php echo $ui_lang?>">
			<table style="font-family: arial; font-size: 84%;" cellspacing="5">
				...
				<tr>
					<td align="<?php echo $alignment ?>">
					<input type="checkbox" name="invert_sense" id="invert_sense" <?php if ($invert_sense==true) echo checked; ?> >
					</td>
					<td>
					<label for="invert_sense">
					<?php echo $messages['invert_sense'] ?> inverse sense
					</label>
					</td>
				<tr>
...
<a href="http://de.wikipedia.org/wiki/Benutzer:Flominator">by Flominator</a> <?php print_translator($ui_lang)?>
